        ...
        <div class="callout">
            <div class="row">
                <div class="medium-6 columns">
                    <label>ชื่องาน :<?=$campaign->name?> สถานะ :<?=$campaign->status?>
                    </label>
                </div>
                ...
                <div class="medium-12 columns">
                    <label>รายละเอียด
                        <textarea id="description" placeholder="None" rows="10" disabled><?=$campaign->description?></textarea>
                    </label>
                </div>
                <div class="medium-4 columns">
                    <label>url ร้าน <a href="<?=$campaign->url?>"><?=$campaign->url?></a>
                    </label>
                </div>
                <div class="medium-4 columns">
                    <label>วันที่เริ่ม : <?=$ci->m_time->unix_to_datepicker($campaign->start_date)?>
                    </label>
                </div>
                <div class="medium-4 columns">
                    <label>วันที่สิ้นสุด : <?=$ci->m_time->unix_to_datepicker($campaign->start_date)?>
                    </label>
                </div>
            </div>
