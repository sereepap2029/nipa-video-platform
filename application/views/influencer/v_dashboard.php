        ...
        <div class="callout">
            ...
            <div class="row">
                <div class="large-4 medium-4 columns">
                    <p><a href="<?=site_url("brand")?>">Dashboard</a>
                        <br />Everything you need to know about using the framework.</p>
                </div>
                <div class="large-4 medium-4 columns">
                    <p><a href="<?=site_url("brand/creator")?>">Creator</a>
            ...
            <div class="row">
                ...
                <div class="large-4 medium-4 medium-pull-2 columns">
                    <p><a href="https://twitter.com/ZURBfoundation">Chat room</a>
                ...
                <div class="large-4 medium-4 medium-pull-2 columns">
                    <p><a href="https://twitter.com/ZURBfoundation">Reward</a>
                        <br />Ping us on Twitter if you have questions. When you build something with this we'd love to see it (and send you a totally boss sticker).</p>
                </div>
            </div>
        </div>
